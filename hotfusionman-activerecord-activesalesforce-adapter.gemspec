...
Gem::Specification.new do |s|
  s.name = %q{hotfusionman-activerecord-activesalesforce-adapter}
  s.version = "2.3.7"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Doug Chasman", "Luigi Montanez", "Senthil Nayagam", "Justin Ball", "Jesse Hallett", "Andrew Freeberg", "Albert Davidson Chou"]
  s.date = %q{2011-06-30}
  s.email = %q{HotFusionMan@GMail.com}
  s.extra_rdoc_files = [
    "README"
  ]
  s.files = [
    ...
    "Rakefile",
    "VERSION",
    "hotfusionman-activerecord-activesalesforce-adapter.gemspec",
  ...
  s.homepage = %q{http://github.com/HotFusionMan/hotfusionman-activerecord-activesalesforce-adapter}
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.3.7}
  s.summary = %q{ActiveSalesforce (ASF) is a Rails connection adapter that provides direct access to Salesforce.com hosted data and metadata via the ActiveRecord model layer. Objects, fields, and relationships are all auto surfaced as ActiveRecord attributes and rels.}
  s.test_files = ["test/unit/basic_test.rb", "test/unit/recorded_test_case.rb"]
